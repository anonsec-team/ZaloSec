...
#	if os.getcwd() != "C:\Program Files (x86)\anonsec":
#		os.chdir("C:\Program Files (x86)\anonsec")
...
def ajuda():
 ...
 | |__| (_| | | | | (_| | | |_) | |  | | | | | (_| |
  \____\__,_|_| |_|\__, |_|_.__/|_|  |_|_| |_|\__,_|
                   |___/%s              Beta - v%s
  %sDashboard Finder%s
  anonsec %s | coded by Fnkoc
usage: anonsec.py -u[URL] -w[WORDLIST] -t[THREADS] -g -d[DORK] -s[OUTPUT] \
...
================================================================================
Examples:
python anonsec.py -u facebook.com
python anonsec.py -u facebook.com -v -s facebook
python anonsec.py -u facebook.com -w /root/diretorios.txt -t 10 -v
python anonsec.py -u facebook.com -g -v
python anonsec.py -u facebook.com -g -d 'site:facebook.com inurl:login' -s \
face
python anonsec.py -u facebook.com -v -n
python anonsec.py -u facebook.com -a
python anonsec.py -u facebook.com -p 187.25.2.485:8080
python anonsec.py -u facebook.com -T
python anonsec.py -u facebook.com --ext php
...
parser = argparse.ArgumentParser(description = "anonsec", add_help = False)
